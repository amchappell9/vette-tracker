    ...
    <div>
      <div ref={headerRef} className="bg-gray-700 pb-32">
        <Disclosure as="nav">
          {({ open }) => (
            <>
              <div className="max-w-7xl mx-auto py-4 sm:px-6 md:px-8 lg:px-8">
                <div className="flex justify-between items-center h-16 px-4 sm:px-0">
                  ...
                  <div className="-mr-2 flex md:hidden">
                    {/* Mobile menu button */}
                    <Disclosure.Button className="inline-flex items-center justify-center p-2 rounded-md text-gray-200 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
        ...
        <header
          className={
            backLinkTextState && backLinkConfigState ? "pb-4" : " pb-4"
          }
        >
          {/* Back Link */}
